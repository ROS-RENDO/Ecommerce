  ...
  return (
    <div className="w-[931px] h-[246px] border border-black rounded-2xl">
      ...
      <div className="flex mt-2 ml-5 gap-5 w-[238px] items-center justify-between ">
        ...
        <button onClick={handleAddToCart} className="cursor-pointer border border-black w-[121px] h-[28px] flex justify-center items-center rounded-[20px] text-[12px] bg-[#3E0C7F] text-white text-nowrap">
      ...
      <div className="flex px-5 gap-2 mt-2">
        {colors.map((color) => (
          ...
          >
            ...
            <div className="w-[17px] h-[17px] rounded-full z-10" style={{ backgroundColor: color }}></div>
          </div>
        ))}
      </div>
