  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute left-4 top-1/2 transform -translate-y-1/2 rotate-90 bg-opacity-50 text-white px-3 py-1 rounded hover:bg-opacity-70 z-1"
      >
        <Image
      ...
      <button
        ...
        className="absolute right-4 top-1/2 transform -translate-y-1/2 -rotate-90 bg-opacity-50 text-white px-3 py-1 rounded hover:bg-opacity-70 z-1"
      >
        <Image
          src="/assets/image2.png"
          alt="right-icon"
