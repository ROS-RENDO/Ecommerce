    ...
    <div className="w-[1700px] h-[1380px]  bg-white z-10 flex items-center justify-center">
      <div className="w-[1440px] h-[850px] border mb-70 relative">
        ...
        <form onSubmit={handleSubmit} className="absolute right-1/4 top-55 space-y-6">
          ...
          <div className="flex justify-center items-center bg-[#3C215F] w-[485px] h-[50px] rounded-[12px] text-white absolute top-105">
            <button type="submit" className="text-[14px]">Sign up</button>
          </div>
